...
const Footer = () => {
  return (
    <div>
      <footer className="footer sm:footer-horizontal md:footer-vertical bg-neutral text-neutral-content p-10">
        ...
        <div className="w-full flex flex-col items-center justify-center text-center">
          <p className="font-semibold text-lg">Dream. Play. Discover.</p>
          <p className="text-gray-400">
            Unleashing Creativity Every Day by Making Your Childhood Magical.
          </p>
        </div>
        <nav className="w-full mx-auto flex flex-col items-center">
